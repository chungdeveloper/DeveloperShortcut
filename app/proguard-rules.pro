...
-keep class com.aiyaapp.** { *; }
-dontwarn com.aiyaapp.**

-keep class **.cpp { *; }
-keep class **.h { *; }

-keep class smartmedia.musictv.model.** { *; }
-dontwarn smartmedia.musictv.model.**
...
-keepclasseswithmembernames, includedescriptorclasses class in.uncod.android.bypass.Document { *; }
-keepclasseswithmembernames, includedescriptorclasses class in.uncod.android.bypass.Element { *; }

-keepclasseswithmembernames class * { native <methods>; }

-keep class rnd.chungld.karalyric.** {
    *;
 }
